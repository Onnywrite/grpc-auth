CREATE TABLE IF NOT EXISTS sessions (
    ...
    user_fk BIGINT ON DELETE CASCADE NOT NULL,
    service_fk BIGINT ON DELETE CASCADE NOT NULL,
    ip CIDR NOT NULL,
    browser VARCHAR(32),
    os VARCHAR(16),
    ...
    FOREIGN KEY (user_fk, service_fk) REFERENCES signups(user_fk, service_fk)
);
