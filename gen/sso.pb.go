...
var file_sso_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x84, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x28,
	0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x55, 0x70, 0x12, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x61, 0x75,
	0x74, 0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x27, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x49,
	...
	0x6e, 0x12, 0x29, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x4f, 0x75, 0x74, 0x12, 0x0b, 0x2e, 0x61, 0x75,
	0x74, 0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
...
var file_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.SignUp:input_type -> auth.AuthRequest
	0, // 1: auth.Auth.LogIn:input_type -> auth.AuthRequest
	1, // 2: auth.Auth.LogOut:input_type -> auth.Token
	1, // 3: auth.Auth.SignUp:output_type -> auth.Token
	1, // 4: auth.Auth.LogIn:output_type -> auth.Token
	2, // 5: auth.Auth.LogOut:output_type -> auth.NullResponse
