...
type Storage interface {
	...
	UserByLogin(ctx context.Context, login string) (*models.SavedUser, ero.Error)
...
func (w *Wrapper) SaveSession(ctx context.Context, session *models.Session) (*models.SavedSession, ero.Error) {
	...
	case ero.Has(err, storage.ErrFKConstraint):
		...
		return nil, ero.NewClient(auth.ErrSignupNotExists)
	case ero.Has(err, storage.ErrUniqueConstraint):
		log.Error("session already exists")
		return nil, ero.NewClient(auth.ErrSessionAlreadyOpened)
	case err != nil:
...
func (w *Wrapper) session(ctx context.Context, get getSessionFn, keys ...any) (*models.SavedSession, ero.Error) {
	...
	case ero.Has(err, storage.ErrEmptyResult):
		...
		return nil, ero.NewClient(auth.ErrSessionNotExists)
	case err != nil:
...
func (w *Wrapper) SaveSignup(ctx context.Context, signup models.Signup) (*models.SavedSignup, ero.Error) {
	...
	case ero.Has(err, storage.ErrFKConstraint):
		...
		return nil, ero.NewClient(auth.ErrServiceNotExists)
	case ero.Has(err, storage.ErrUniqueConstraint):
		...
		if su.IsDeleted() {
			...
			return nil, ero.NewClient(auth.ErrSignedOut)
		}
		if su.IsBanned() {
			log.Error("signup banned")
			return nil, ero.NewClient(auth.ErrSignupBanned)
		}
		return nil, ero.NewClient(auth.ErrAlreadySignedUp)
	case err != nil:
...
func (w *Wrapper) signup(ctx context.Context, get getSignupFn, keys ...any) (*models.SavedSignup, ero.Error) {
	...
	if su.IsDeleted() {
		log.Error("signed out")
		return su, ero.NewClient(auth.ErrSignedOut)
	}

	if su.IsBanned() {
		log.Error("signup banned")
		return su, ero.NewClient(auth.ErrSignupBanned)
	}
...
func (w *Wrapper) SaveUser(ctx context.Context, user *models.User) (*models.SavedUser, ero.Error) {
	...
	case ero.Has(err, storage.ErrUniqueConstraint):
		...
		return nil, ero.NewClient(auth.ErrUserAlreadyRegistered)
	case err != nil:
...
//	ErrUserDeleted
//	Internal
func (w *Wrapper) UserByLogin(ctx context.Context, login string) (*models.SavedUser, ero.Error) {
...
func (w *Wrapper) user(ctx context.Context, get getUserFn, key any, keyType string) (*models.SavedUser, ero.Error) {
	...
	case ero.Has(err, storage.ErrEmptyResult):
		...
		return nil, ero.NewClient(auth.ErrInvalidCredentials)
	case err != nil:
	...
	if saved.IsDeleted() {
		...
		return saved, ero.NewClient(auth.ErrUserDeleted)
	}
